...
gulp.task('concat-dashboard', function(){
...
// watch & serve
gulp.task('serve', ['sass-dashboard', 'sass-front', 'concat-dashboard', 'concat-front'], function(){
  browserSync.init({
    server: './src'
  });
  ...
  gulp.watch(['src/js/*js'], ['concat-dashboard', 'concat-front']).on('change', browserSync.reload);
});
